...
{
	double CM_conit, CM_crate, CM_ccmax, CM_el0, CM_h__, CM_hmin, CM_hmxi, CM_hu, CM_rc, CM_tn, CM_uround, CM_pdest, CM_pdlast, CM_ratio, CM_hold, CM_rmax;
	double  CM_el[13], CM_elco[156], CM_tesco[36];
	double CM_rls[218];
	double CM_tsw, CM_pdnorm;
	double CM_cm1[12], CM_cm2[5];
	double CM_rlsa[22];
	double CM_sm1[12];
	int CM_init, CM_mxstep, CM_mxhnil, CM_nhnil, CM_nslast, CM_nyh, CM_icf, 
	...
	int CM_ialth, CM_ipup, CM_lmax, CM_nqnyh, CM_nslp;
	int CM_ils[37];
	int CM_insufr, CM_insufi, CM_ixpr, CM_jtyp, CM_mused, CM_mxordn, CM_mxords; 
	int CM_icount, CM_irflag;
	int CM_ilsa[9];
};
// End Common Block  
...
template<typename Fex, typename Jex>
void Sanders(Fex fex, int *neq, value_type *y, value_type *t, value_type *tout, int *itol, value_type *rtol, value_type *atol, int *itask, int *istate, int *iopt, value_type *rwork, int *lrw, int *iwork, int *liw, Jex jac, int *jt, struct cuLsodaCommonBlock *common, int *err)
{
...
#endif
template<typename Fex,typename Jex>
int dlsoda_(Fex f, int *neq, double *y, double *t, double *tout, int *itol, double *rtol, double *atol, int *itask, int *istate, int *iopt, double *rwork, int *lrw, int *iwork, int *liw, Jex jac, int *jt, struct cuLsodaCommonBlock *common)
{
    /* Initialized data */
